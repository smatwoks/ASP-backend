...
//     // const verificationLink = `http://localhost:4000/password?token=${verificationToken}+${email}`;
...
app.post('/ok',async(req,res)=>{
    ...
    const mailOptions = {
        ...
        to: 'luryreddy@gmail.com',email,
        subject: 
        ` Subject: Product or Service Inquiry`,
        // `${name}`,
        // text: `Click on the following link to verify your email address: ${verificationLink}`
        text: 
        `Dear ASP Team,
        I hope this message finds you well. I am writing to inquire about a product or service that we require. Below are the details:
${msg}

Contact Person: ${phone}

Please let us know the next steps and any additional information you may need.Thank you for your attention to this matter.
